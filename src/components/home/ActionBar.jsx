...
const ActionBar = ({term}) => {
  ...
  return (
    <div className="w-full flex justify-between items-center">
      ...
      <div>
        <button className='flex space-y-[30px] items-center transition-all duration-[0.5s] ease-out hover:bg-primary-400 outline-none mx-4 text-primary-50 bg-primary-600 py-2 px-8 rounded-full hover:outline-primary-600 hover:outline-dotted hover:outline-offset-2' onClick={()=>navigate('/add')}>
